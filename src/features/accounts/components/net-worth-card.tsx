...
export function NetWorthCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-zinc-800/90 bg-gradient-to-br from-zinc-900/90 via-zinc-900/60 to-zinc-950/80 backdrop-blur-2xl p-6 sm:p-8 text-zinc-100 shadow-2xl shadow-black/40">
      {/* Decorative Glow */}
