  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* 1. Total Net Worth */}
        <div className="relative overflow-hidden rounded-3xl border border-zinc-800/80 bg-gradient-to-br from-zinc-900/90 via-zinc-900/60 to-zinc-950/90 backdrop-blur-xl p-5 space-y-3 flex flex-col justify-between group hover:border-zinc-700 transition-all shadow-lg">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-zinc-800/80 bg-zinc-900/60 backdrop-blur-xl p-5 space-y-3 flex flex-col justify-between group hover:border-emerald-500/30 transition-all shadow-lg">
          <div className="flex items-center justify-between">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-zinc-800/80 bg-zinc-900/60 backdrop-blur-xl p-5 space-y-3 flex flex-col justify-between group hover:border-rose-500/30 transition-all shadow-lg">
          <div className="flex items-center justify-between">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-indigo-950/40 via-zinc-900/80 to-zinc-950/90 backdrop-blur-xl p-5 flex flex-col justify-between group hover:border-indigo-500/40 transition-all shadow-lg space-y-3.5">
